...
export default function App() {
  ...
  const handleContactSubmit = (e) => {
    ...
    if (contactForm.name && contactForm.email && contactForm.message) {
      emailjs
        .send(
          "service_gm6mhss", // Replace with your Service ID
          "template_w6jqw9o", // Replace with your Template ID
          {
          ...
          "xUefzIrV61kjolhp0", // Replace with your Public Key
        )
        .then(() => {
          setIsSubmitted(true);
  ...
  return (
    <div
      id="portfolio-root"
      className={`min-h-screen transition-colors duration-300 ${isDark ? "bg-slate-950 text-slate-100" : "bg-slate-50 text-slate-800"}`}
    >
      {/* Dynamic Floating Navbar */}
      <nav
        id="app-navbar"
        className={`fixed top-0 left-0 w-full z-50 border-b transition-colors duration-300 backdrop-blur-md ${isDark ? "bg-slate-950/80 border-slate-800" : "bg-white/80 border-slate-200"}`}
      >
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <a href="#hero" className="flex items-center gap-2 group">
                <span
                  className={`p-2 rounded-lg text-white bg-gradient-to-tr from-cyan-500 to-blue-600 transition-transform group-hover:rotate-12`}
                >
                  <Terminal size={18} />
                </span>
                <span
        ...
        {mobileMenuOpen && (
          <div
            ...
            className={`md:hidden border-b px-4 pt-2 pb-4 space-y-1 transition-colors duration-200 ${isDark ? "bg-slate-900 border-slate-800" : "bg-white border-slate-200"}`}
          >
            {[
              { id: "hero", label: "Home" },
      ...
      <main className="pt-16">
        ...
        <section id="hero" className="relative py-20 md:py-32 overflow-hidden">
          <div className="absolute inset-0 z-0 opacity-15">
            <div
              className={`absolute top-0 left-1/4 w-96 h-96 rounded-full blur-3xl ${isDark ? "bg-cyan-500" : "bg-cyan-300"}`}
            ></div>
            <div
              className={`absolute bottom-0 right-1/4 w-96 h-96 rounded-full blur-3xl ${isDark ? "bg-blue-600" : "bg-blue-300"}`}
            ></div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
              ...
              <div className="md:col-span-7 space-y-6 text-center md:text-left">
                ...
                <h2
                  className={`text-xl sm:text-2xl font-bold tracking-tight ${isDark ? "text-slate-300" : "text-slate-700"}`}
                >
                  {portfolioData.personalInfo.title}
                </h2>

                <p
                  className={`text-base max-w-xl mx-auto md:mx-0 leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}
                >
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-4">
                  ...
                  <a
                    ...
                    className={`flex items-center gap-2 px-5 py-3 rounded-xl font-semibold text-sm border transition-all duration-200 ${
                      isDark
                        ? "bg-slate-900 border-slate-800 text-slate-300 hover:bg-slate-800 hover:text-white animate-pulse"
                        : "bg-white border-slate-200 text-slate-700 hover:bg-slate-50"
                    }`}
                  >
              ...
              <div className="md:col-span-5 flex justify-center">
                <div className="relative group">
                  ...
                  <div
                    className={`relative p-2 rounded-full border ball-bounce ${isDark ? "bg-slate-900/80 border-slate-800" : "bg-white border-slate-200"}`}
                  >
                    <img
                    ...
                    />
                    <div
                      className={`absolute bottom-6 right-6 flex items-center gap-2 px-3 py-1.5 rounded-xl border shadow-lg ${
                        isDark
...
`}</style>
        ...
        <section
          id="about"
          className={`py-20 border-t ${isDark ? "bg-slate-950/40 border-slate-900" : "bg-slate-50/50 border-slate-200"}`}
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p
                className={`mt-4 text-base ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                A deep dive into my professional goals, academic history, and
                background.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              <div className="lg:col-span-6 space-y-6">
                <div
                  className={`p-6 sm:p-8 rounded-2xl border ${isDark ? "bg-slate-900/40 border-slate-800" : "bg-white border-slate-200"}`}
                >
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-relaxed ${isDark ? "text-slate-300" : "text-slate-700"}`}
                  >
                    As a computer science student, my primary academic focus is
                    centered on scalable architectures, structural optimization,
                    and intelligent systems. I spend much of my free time
                    benchmarking system efficiencies, analyzing complex
                    algorithms on LeetCode, and developing robust full-stack
                    applications.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:col-span-6 space-y-6">
                <h3 className="text-xl font-bold flex items-center gap-2 mb-2">
                  <Award size={20} className="text-cyan-500" /> Education
                  History
                </h3>
                ...
                <div className="space-y-6 relative before:absolute before:top-2 before:bottom-2 before:left-3.5 before:w-0.5 before:bg-slate-800">
                  {portfolioData.education.map((edu, idx) => (
                    ...
                    >
                      {/* Timeline dot */}
                      <span
                        className={`absolute left-2.5 top-2.5 w-2.5 h-2.5 rounded-full ring-4 transition-all group-hover:scale-125 ${
                          isDark
                            ? "bg-cyan-500 ring-cyan-500/10"
                      ...
                      >
                        ...
                        <p
                          className={`text-xs font-semibold mb-3 text-cyan-500`}
                        >
                          {edu.institution} <span className="mx-1">•</span>{" "}
                          <span className="text-emerald-500">{edu.grade}</span>
                        </p>
                        ...
                        <ul className="space-y-1.5">
                          {edu.details.map((detail, dIdx) => (
                            <li
                              key={dIdx}
                              className={`text-xs flex items-start gap-2 ${isDark ? "text-slate-400" : "text-slate-600"}`}
                            >
                              <ChevronRight
                                size={12}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p
                className={`mt-4 text-base ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                A taxonomy of my core competencies, framework familiarity,
                tools, and computer science concepts.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div
                id="skills-group-languages"
                className={`p-6 rounded-2xl border ${isDark ? "bg-slate-900/30 border-slate-800" : "bg-white border-slate-200"}`}
              >
              ...
              {filteredProjects.map((project) => (
                <div
                  ...
                  className={`group rounded-3xl border overflow-hidden flex flex-col transition-all duration-300 hover:-translate-y-1.5 ${
                    isDark
                      ? "bg-slate-900/60 border-slate-800/80 hover:border-slate-700 hover:shadow-cyan-950/20 hover:shadow-xl"
                      : "bg-white border-slate-200/80 hover:border-slate-300 hover:shadow-slate-200/50 hover:shadow-xl"
                  }`}
                >
                  <div className="relative aspect-video overflow-hidden group">
                    ...
                    />
                    {project.featured && (
                      <span className="absolute top-3 left-3 bg-cyan-500 text-white text-3xs font-extrabold uppercase px-2 py-1 rounded-md tracking-wider"></span>
                    )}
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <p
                        className={`text-xs leading-relaxed mb-4 line-clamp-3 ${isDark ? "text-slate-400" : "text-slate-600"}`}
                      >
                        {project.description}
                      </p>
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p
                className={`mt-4 text-base ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                Professional certifications, specializations, and verified skill
                achievements.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {portfolioData.certificates.map((cert, idx) => (
                ...
                >
                  ...
                  />
                  <div
                    className={`p-5 ${isDark ? "bg-slate-950 text-slate-200" : "bg-white text-slate-900"}`}
                  >
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-2xs font-semibold text-cyan-400 mt-1">
                          {cert.organization}
                        </p>
                      </div>
                    </div>
        ...
        <section
          id="coding-profiles"
          className={`py-20 border-t ${isDark ? "bg-slate-950/40 border-slate-100" : "bg-slate-50/50 border-slate-200"}`}
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">
              ...
              <p
                className={`mt-4 text-base ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                Tracking active metrics and problem-solving benchmarks across
                major competitive platforms.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p
                className={`mt-4 text-base ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                Visualizing language contributions, activity metrics, and top
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                  ...
                  {portfolioData.githubProfile.topRepos.map((repo, idx) => (
                    ...
                    >
                      <div className="space-y-3">
                        ...
                        <p
                          className={`text-4xs leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}
                        >
                          {repo.description}
                        </p>
                      </div>
              ...
              <div className="lg:col-span-4 flex flex-col justify-between">
                <div
                  className={`p-6 rounded-3xl border flex-1 flex flex-col justify-between ${
                    isDark
                      ? "bg-slate-900/30 border-slate-800"
                      : "bg-white border-slate-200"
                  }`}
                >
                  <div>
                    ...
                    <div className="w-full h-4 rounded-full overflow-hidden flex mb-6">
                      {portfolioData.githubProfile.languages.map(
                        (lang, idx) => (
                          <div
                            key={idx}
                            style={{
                    ...
                    <div className="space-y-2.5">
                      {portfolioData.githubProfile.languages.map(
                        (lang, idx) => (
                          <div
                            key={idx}
                            className="flex justify-between items-center text-4xs font-mono"
                          >
                  ...
                  <div className="mt-8 pt-6 border-t border-slate-800/20 grid grid-cols-2 gap-4 text-center">
                    <div className="p-3 bg-slate-950/40 rounded-xl border border-slate-800/30">
                      <span className="block text-base font-black text-white">
                        {portfolioData.githubProfile.followers}
                      </span>
                      <span className="text-5xs text-slate-500 uppercase tracking-widest">
                        Followers
                      </span>
                    </div>
                    <div className="p-3 bg-slate-950/40 rounded-xl border border-slate-800/30">
                      <span className="block text-base font-black text-cyan-400">
                        {portfolioData.githubProfile.totalStars}
                      </span>
                      <span className="text-5xs text-slate-500 uppercase tracking-widest">
                        Stars Gained
                      </span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p
                className={`mt-4 text-base ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                Review my educational metrics, technical timeline, and export a
                localized copy directly.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div
                ...
                className="p-8 sm:p-12 rounded-3xl border shadow-2xl bg-white text-slate-900 font-sans leading-relaxed"
              >
                <div className="border-b-2 border-slate-800 pb-6 flex flex-wrap justify-between items-start gap-4">
                  ...
                  <div className="text-xs text-slate-600 text-right space-y-1 font-mono">
                    <p className="flex items-center gap-1 justify-end">
                      <Mail size={12} /> {portfolioData.personalInfo.email}
                    </p>
                    <p className="flex items-center gap-1 justify-end">
                      <Phone size={12} /> {portfolioData.personalInfo.phone}
                    </p>
                    <p className="flex items-center gap-1 justify-end">
                      <MapPin size={12} /> {portfolioData.personalInfo.location}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mt-8">
                  ...
                  <div className="md:col-span-8 space-y-6">
                    <div className="space-y-2">
                      <h4 className="text-xs font-black uppercase tracking-widest text-slate-900 border-b border-slate-300 pb-1">
                        ...
                        {["languages", "frameworks", "tools", "concepts"].map(
                          (cat) => (
                            <div key={cat} className="space-y-1">
                              <span className="text-4xs font-black uppercase tracking-wider text-slate-400 block capitalize">
                                {cat}
                              </span>
                              <div className="flex flex-wrap gap-1">
                                {portfolioData.skills
                                  ...
                                  .map((skill, idx) => (
                                    <span
                                      key={idx}
                                      className="text-4xs bg-slate-100 border border-slate-200 px-1.5 py-0.5 rounded text-slate-700 font-medium"
                                    >
                                      {skill.name}
                                    </span>
                                  ))}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p
                className={`mt-4 text-base ${isDark ? "text-slate-400" : "text-slate-600"}`}
              >
                Get in touch for internships, projects, competitive training
                collaborations, or professional queries.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
              ...
              <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
                <div
                  className={`p-6 sm:p-8 rounded-3xl border flex-1 space-y-8 ${
                    isDark
                      ? "bg-slate-900/30 border-slate-800"
                      : "bg-white border-slate-200"
                  }`}
                >
                  <div>
                    ...
                    >
                      Feel free to ping me on phone, drop a mail, or check my
                      professional handles. I usually reply within a few hours.
                    </p>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    >
                      ...
                      <div>
                        <span className="block text-4xs uppercase tracking-widest text-slate-500">
                          Email Address
                        </span>
                    ...
                    <div className="text-center py-10 space-y-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-400 leading-relaxed max-w-sm mx-auto">
                          Thank you for connecting! Your message query has been
                          securely locked in our offline client dispatch
                          database.
                        </p>
                      </div>
                    </div>
                    ...
                    <form onSubmit={handleContactSubmit} className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          <label className="text-4xs font-extrabold text-slate-400 uppercase tracking-widest block">
                            Your Full Name
                          </label>
                          <input
                            type="text"
      ...
      {/* FOOTER */}
      <footer
        className={`border-t py-12 transition-colors duration-200 ${isDark ? "bg-slate-950 border-slate-900" : "bg-white border-slate-200"}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <div className="flex justify-center items-center gap-2">
            ...
            <span
              className={`font-bold tracking-tight text-sm ${isDark ? "text-white" : "text-slate-900"}`}
            >
              Adarsh<span className="text-cyan-500">.Dev()</span>
            </span>
          </div>
          ...
          <p
            className={`text-4xs uppercase tracking-widest max-w-sm mx-auto ${isDark ? "text-slate-500" : "text-slate-400"}`}
          >
            Built using fully responsive React, Tailwind, and custom vector
            graphic arrays. All code structures optimized for immediate hosting.
          </p>

          <div className="flex justify-center gap-6 text-slate-500">
            <a
              href="#hero"
              className="hover:text-cyan-400 transition-colors text-2xs"
            >
              Home
            </a>
            <a
